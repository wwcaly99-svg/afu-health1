...
// All card fields aligned with Dify contract: period_text, items_preview, primary_action
  ...
  },
  {
    ...
    bot: {
      ...
      card: {
        type: 'plan',
        title: '先从一个最容易开始的点做起',
        period_text: '适合血糖刚偏高时的起步建议',
        items_preview: ['含糖饮料先停 3 天', '主食量先减一点', '三餐尽量规律'],
        primary_action: '查看详情',
      },
      profile_preview: null,
    },
  },
  {
    ...
    bot: {
      ...
      card: {
        type: 'plan',
        title: '3 天控糖起步计划',
        period_text: '先稳住，再逐步细化',
        items_preview: ['早餐不喝甜饮料', '午餐主食减一点', '晚饭后走 10 分钟'],
        primary_action: '查看详情',
      },
      profile_preview: null,
    },
  },
  {
    ...
    bot: {
      ...
      card: {
        type: 'plan',
        title: '简化后的起步计划',
        period_text: '适合下班晚、精力有限',
        items_preview: ['晚饭只先改主食量', '不要求走路，只先停夜宵', '先做 2 天'],
        primary_action: '查看详情',
      },
      profile_preview: null,
    },
...
export const mockResponses = {
  ...
  血糖: {
    ...
    card: {
      type: 'plan',
      title: '血糖管理入门计划',
      period_text: '从最简单的调整开始',
      items_preview: ['减少含糖饮料', '控制主食量', '餐后适量活动'],
      primary_action: '查看详情',
    },
    profile_preview: null,
  },
  计划: {
    ...
    card: {
      type: 'plan',
      title: '个性化健康计划',
      period_text: '根据你的情况定制',
      items_preview: ['调整饮食结构', '增加轻度运动', '规律作息'],
      primary_action: '查看详情',
    },
    profile_preview: null,
  },
